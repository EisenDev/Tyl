...
@media (max-width: 680px) {
  ...
  .we-overlay { align-items: flex-start; overflow-y: auto; padding: 2rem 1rem 4rem; }
  /* Desktop stays row; mobile: icon on TOP, text/riddle on BOTTOM */
  ...
  /* Shrink the icon so it doesn't eat vertical space */
